...
void Citation::GetContents(pugi::xml_node& node)
{
	for (pugi::xml_node instruction = node.first_child(); instruction; instruction = instruction.next_sibling())
	{
		...
		{
			//title = pugi::as_wide(instruction.child_value());
		...
		//	aternateTitle.push_back(pugi::as_wide(instruction.child_value()));
		...
		/*	date.push_back(Date());
			date.back().GetContents(instruction);*/
		...
		else if (!strcmp(instructionName, "S100CI:edition"))
		{
			...
			//edition = pugi::as_wide(instruction.child_value());
		...
		else if (!strcmp(instructionName, "S100CI:editionDate"))
		{
			...
			//editionDate.GetContents(instruction);
		...
		else if (!strcmp(instructionName, "S100CI:identifier"))
		{
			...
			//identifier = pugi::as_wide(instruction.child_value());
		...
		else if (!strcmp(instructionName, "S100CI:identifierType"))
		{
			...
			//identifierType = pugi::as_wide(instruction.child_value());
		...
		//	citedResponsibleParty.GetContents(instruction);
		...
		else if (!strcmp(instructionName, "S100CI:presentationForm"))
		{
			...
			//presentationForm.GetContents(instruction);
		...
		else if (!strcmp(instructionName, "S100CI:otherCitationDetails"))
		{
			...
			//otherCitationDetails = pugi::as_wide(instruction.child_value());
		...
		else if (!strcmp(instructionName, "S100CI:collectiveTitle"))
		{
			...
			//collectiveTitle = pugi::as_wide(instruction.child_value());
		...
		else if (!strcmp(instructionName, "S100CI:ISBN"))
		{
			...
			//ISBN = pugi::as_wide(instruction.child_value());
		...
		else if (!strcmp(instructionName, "S100CI:ISSN"))
		{
			...
			//ISSN = pugi::as_wide(instruction.child_value());
