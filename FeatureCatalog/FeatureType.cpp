...
//
//			std::wstring associatename = fb.GetFeatureTypePointer().Getvalue();
//			if (associatename.compare(L"") == 0)
//			{
//				/*		for (auto itor = fb.GetFeatureTypePointer().GetattributesPointer()->begin();
//							itor != fb.GetFeatureTypePointer().GetattributesPointer()->end();
//							itor++)*/
//
//				auto pointer = fb.GetFeatureTypePointer().GetattributesPointer();
